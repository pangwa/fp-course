...
find ::
  ...
  -> Optional a
find pred  =
   headOr Empty . map Full . filter pred
...
lengthGT4 l =
  let
    lengthGreater 0 Nil = False
    lengthGreater 0 _ = True
    lengthGreater n Nil = False
    lengthGreater n (_ :. t) = lengthGreater (n - 1) t
  in
    lengthGreater 4 l
